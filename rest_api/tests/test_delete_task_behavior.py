"""
Tests for the updated delete_task behavior that only allows deletion of completed tasks.
"""
...
class TestDeleteTaskBehavior:
    """Test cases for the updated delete_task behavior."""
