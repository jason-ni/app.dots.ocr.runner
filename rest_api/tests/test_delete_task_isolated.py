"""
Isolated tests for the updated delete_task behavior that only allows deletion of completed tasks.
These tests mock the entire HTTP layer to focus on the business logic.
"""
...
class TestDeleteTaskIsolated:
    """Isolated test cases for the updated delete_task behavior."""
